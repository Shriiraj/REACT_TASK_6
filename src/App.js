      ...
      <div className="main-content">
        {selectedSection === "Home" && (
          <div className="content-section">
            ...
            <p>
              I'm Shriraj Patil, a web developer who's dedicated to crafting
...
monitor and assess the health and performance of electric vehicle (EV) motors in real-time.
            ...
            <div className="content-section">
              <h2>About Me</h2>
              <p>
                Hi, I'm SHRIRAJ PATIL, a web developer with expertise in HTML and
            ...
            <div className="content-section">
              ...
              <div className="content-section">
                <h2>Contact Me</h2>
                <p>Name: SHRIRAJ PATIL</p>
                <p>Mobile: 8306077257</p>
                <p>Email: shri30raj@gmail.com</p>
                <p>
                  Linkedin:{" "}
                  <a href="https://www.linkedin.com/in/shriraj-patil-3b34a11a6">
                    {" "}
                    Shriraj Patil{" "}
                  </a>
                </p>
      ...
      {selectedSection === "About" && (
        <div className="content-section">
          <h2>About Me</h2>
          <p>
            Hi, I'm SHRIRAJ PATIL,  a web developer with expertise in HTML and CSS.
